...
const FeaturedLogoLink = (props: {
  ...
  return (
    <Link
      ...
      aria-label={"icon for " + props.ariaLabel}
    ...
    >
      <div className="flex shrink-0 flex-row items-center gap-2 *:shrink-0 *:text-lg">
...
export default FeaturedLogoLink;
